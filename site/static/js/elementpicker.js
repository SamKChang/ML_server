...
*/
	...
	function buildDays(firstOfMonth, numDays, currentMonthView, currentYearView) {
      ...
      if(i>0 && i<7){
        ...
        var s = i-6
				row.appendChild(buildNode('td', todayClassName, buildNode('span', { className: 'day' }, elist[s])));
      }else{
				row.appendChild(buildNode('td', todayClassName, buildNode('span', { className: 'day' }, elist[0])));
      }
