...
#output_file("templates/ajax_source_realtime.html", title="ajax_source_realtime.py example")
source = AjaxDataSource(data_url='http://localhost:5000/data', mode="append",
                        if_modified=True, polling_interval=1000, max_size=125)
output_file('templates/ajax_test.html')
p = figure()
p.plot_width=400
p.plot_height=400
...
#
#figJS, figDiv = autoload_static(p, CDN, "static/temp/plot_test.js")
#with open('static/temp/plot_test.js', 'w') as f:
#  f.write(figJS)
